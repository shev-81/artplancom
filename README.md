...
В качестве базы данных PostgreSQL. Spring Boot 2 и Hibernate (JPA). Реализован дополнительный функционал загрузки изображений в S3 хранилище MiniO. 
